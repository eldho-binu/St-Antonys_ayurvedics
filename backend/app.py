...
def serialize_patient(patient):
    ...
    if patient:
        ...
        # Enforce defaults for new Ayurvedic fields
        patient['primary_dosha'] = patient.get('primary_dosha') or ""
        patient['chief_complaint'] = patient.get('chief_complaint') or ""
        patient['treatments'] = patient.get('treatments') or ""
...
def create_patient():
    ...
    try:
        ...
        patient_doc = {
            ...
            'phone': data.get('phone', '').strip(),
            'age': int(data['age']),
            'primary_dosha': data.get('primary_dosha', '').strip(),
